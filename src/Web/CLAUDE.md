...
| `pnpm test:scripts` | teste `node:test` pentru convertor (fixture mini-bundle, cu `tiles.geojson` + 2 măști; `node scripts/survey/fixtures/make-mini-bundle.mjs` îl regenerează) |
